          ...
          <div class="greeting-info-main-wrap">
            <div class="greeting-info-wrap">
              ...
              <div class="greeting-info">
                <p>Алексей Слепов</p>
                <p>Director, W&I</p>
                <a class="hover-link" href="tel:89992144020" aria-label="позвонить по номеру">+7 (999) 214-40-20</a>
                <a class="hover-link" href="mailto:a.s@brightrich.moscow" aria-label="написать на почту">a.s@brightrich.moscow</a>
              </div>
            </div>
            <div class="greeting-info-btns">
              <a class="hover-link" href="https://t.me/" aria-label="написать в телеграм" target="_blank">telegram</a>
              <a class="hover-link" href="https://wa.me/79992144020" aria-label="написать в ватсап" target="_blank">whatsapp</a>
            </div>
          </div>
        </div>
      </section>
